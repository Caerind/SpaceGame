...
MODIFICATIONS for Enlivengine (and projects using it) :

- Add const qualifier to void* input parameters (see PR #71 : https://github.com/cmuratori/meow_hash/pull/71)
- Remove the streaming part due to warning C4324
